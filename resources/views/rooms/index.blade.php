                            ...
                            <div class="p-6">
                                ...
                                <div class="flex space-x-2">
                                    <a href="{{ route('rooms.attendance', $room) }}" 
                                       class="bg-green-500 hover:bg-green-700 text-white text-sm font-bold py-2 px-4 rounded flex-1 text-center">
                                        Mark Attendance
                                    </a>
                                    ...
                                    <a href="{{ route('rooms.edit', $room) }}" 
                                       class="bg-yellow-500 hover:bg-yellow-700 text-white text-sm font-bold py-2 px-4 rounded">
                                        Edit
                                    </a>
